...
if (input) input.addEventListener("input", (0, _lodashDebounceDefault.default)(searchCountry, 500));
function searchCountry(event) {
    ...
    (0, _fetchCountriesDefault.default)(countryName).then((res)=>{
        ...
        if (res.length === 1) {
            ...
            <img class="img" src="${item.flags.png}" alt="\u{43A}\u{430}\u{440}\u{442}\u{438}\u{43D}\u{43A}\u{430}">
            </div>`;
            }).join("");
        }
        return;
...
},{"./fetchCountries":"bCGdT","lodash.debounce":"irvaP","@pnotify/core/dist/PNotify.js":"fay4s","@pnotify/mobile/dist/PNotifyMobile.js":"5RXYV","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/mobile/dist/PNotifyMobile.css":"iv3sV","@pnotify/core/dist/BrightTheme.css":"grIyt","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bCGdT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"c4y47":[function() {},{}],"iv3sV":[function() {},{}],"grIyt":[function() {},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequirec490", {})
